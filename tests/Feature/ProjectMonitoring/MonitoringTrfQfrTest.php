...
class MonitoringTrfQfrTest extends TestCase
{
    /**
    ...
    public function testCreatePage()
    {
        ...
        $response = $this->get(route('panel.monitoring-trf.qfr.create'));
    ...
    public function testShowPage()
    {
        ...
        $response = $this->get(route('panel.monitoring-trf.qfr.show', ["qfr" => $report->id]));
    ...
    public function testEditPage()
    {
        ...
        $response = $this->get(route('panel.monitoring-trf.qfr.edit', ["qfr" => $report->id]));
    ...
    public function testDelete()
    {
        ...
        $response = $this->delete(route('panel.monitoring-trf.qfr.delete', ["qfr" => $report->id]));
    ...
    public function testCommentPage()
    {
        ...
        $response = $this->get(route('panel.monitoring-trf.qfr.comment', ["qfr" => $report->id]));
    ...
    public function testCommentSubmit()
    {
        ...
        $response = $this->put(route('panel.monitoring-trf.qfr.comment', ["qfr" => $report->id]), [
    ...
    public function testDownloadPdf()
    {
        ...
        $response = $this->get(route('panel.monitoring-trf.qfr.download', ["qfr" => $report->id]));
