...
class MonitoringEfMarTest extends TestCase
{
    /**
    ...
    public function testCreatePage()
    {
        ...
        $response = $this->get(route('panel.monitoring-ef.mar.create'));
    ...
    public function testShowPage()
    {
        ...
        $response = $this->get(route('panel.monitoring-ef.mar.show', ["mar" => $report->id]));
    ...
    public function testEditPage()
    {
        ...
        $response = $this->get(route('panel.monitoring-ef.mar.edit', ["mar" => $report->id]));
    ...
    public function testDelete()
    {
        ...
        $response = $this->delete(route('panel.monitoring-ef.mar.delete', ["mar" => $report->id]));
    ...
    public function testCommentPage()
    {
        ...
        $response = $this->get(route('panel.monitoring-ef.mar.comment', ["mar" => $report->id]));
    ...
    public function testCommentSubmit()
    {
        ...
        $response = $this->put(route('panel.monitoring-ef.mar.comment', ["mar" => $report->id]), [
    ...
    public function testDownloadPdf()
    {
        ...
        $response = $this->get(route('panel.monitoring-ef.mar.download', ["mar" => $report->id]));
