...
class QfrForm3Test extends TestCase
{
    /**
    ...
    public function testStoreForm()
    {
        ...
        $response = $this->post(route('panel.monitoring-trf.qfr.sub-form.form3.store'), [
            'reasons' => 'Reasons'
        ]);
    ...
    public function testUpdateForm()
    {
        ...
        $response = $this->put(route('panel.monitoring-trf.qfr.sub-form.form3.update', ['form3' => $report->id]), [
            'reasons' => 'Reasons'
        ]);
