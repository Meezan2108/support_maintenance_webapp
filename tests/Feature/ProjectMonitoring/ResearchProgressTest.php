...
class ResearchProgressTest extends TestCase
{
    /**
    ...
    public function testIndexPage()
    {
        ...
        $response = $this->get(route('panel.research-progress.index'));
    ...
    public function testCreatePage()
    {
        ...
        $response = $this->get(route('panel.research-progress.create'));
    ...
    public function testStoreForm()
    {
        ...
        $response = $this->post(route('panel.research-progress.store'), [
            'year' => 2023,
    ...
    public function testShowPage()
    {
        ...
        $response = $this->get(route('panel.research-progress.show', ["report" => $report->id]));
    ...
    public function testEditPage()
    {
        ...
        $response = $this->get(route('panel.research-progress.edit', ["report" => $report->id]));
    ...
    public function testUpdateForm()
    {
        ...
        $response = $this->put(route('panel.research-progress.update', ["report" => $report->id]), [
            'year' => 2023,
            'proposal_id' => $proposal->id,
            'ref_report_type_id' => RefReportType::first()->id,
            'focus_area' => 'Focus Area',
    ...
    public function testDelete()
    {
        ...
        $response = $this->delete(route('panel.research-progress.delete', ["report" => $report->id]));
    ...
    public function testCommentPage()
    {
        ...
        $response = $this->get(route('panel.research-progress.comment', ["report" => $report->id]));
    ...
    public function testCommentSubmit()
    {
        ...
        $response = $this->put(route('panel.research-progress.comment', ["report" => $report->id]), [
            'comment' => 'Comment',
            'is_submited' => 1,
    ...
    public function testDownloadPdf()
    {
        ...
        $response = $this->get(route('panel.research-progress.download', ["report" => $report->id]));
