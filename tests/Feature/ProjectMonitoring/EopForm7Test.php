...
use App\Actions\Test\ProjectMonitoring\CreateEopGenerateAnswerTest;
use App\Actions\Test\ProjectMonitoring\CreateEopTest;
use App\Models\Approvement;
use App\Models\User;
use Tests\TestCase;

class EopForm7Test extends TestCase
{
    /**
    ...
    public function testStoreForm()
    {
        ...
        $answers = (new CreateEopGenerateAnswerTest)->execute($proposal);

        $response = $this->post(route('panel.end-of-project.sub-form.form7.store'), [
            "answers" => $answers,
        ]);
    ...
    public function testUpdateForm()
    {
        ...
        $response = $this->put(route('panel.end-of-project.sub-form.form7.update', ['form7' => $report->id]), [
            "answers" => $answers,
        ]);
