...
class TrfTest extends TestCase
{
    /**
    ...
    public function testIndexPage()
    {
        ...
        $response = $this->get(route('panel.trf.index'));
    ...
    public function testCreatePage()
    {
        ...
        $response = $this->get(route('panel.trf.create'));
    ...
    public function testShowPage()
    {
        ...
        $response = $this->get(route('panel.trf.show', ["proposal" => $proposal->id]));
    ...
    public function testEditPage()
    {
        ...
        $response = $this->get(route('panel.trf.edit', ["proposal" => $proposal->id]));
    ...
    public function testDelete()
    {
        ...
        $response = $this->delete(route('panel.trf.delete', ["proposal" => $proposal]));
    ...
    public function testDownload()
    {
        ...
        $response = $this->get(route('panel.trf.download', ["proposal" => $proposal]));
    ...
    public function testGetCommentPage()
    {
        ...
        $response = $this->get(route('panel.trf.comment', ["proposal" => $proposal]));
    ...
    public function testUpdateComment()
    {
        ...
        $this->actingAs($userAuth);
        $response = $this->put(route('panel.trf.comment', ["proposal" => $proposal]), [
