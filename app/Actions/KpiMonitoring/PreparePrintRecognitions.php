...
class PreparePrintRecognitions
{
    /**
     * Execute the action
     *
    ...
    public function execute(
        ...
        $targetCategory = $targetCategories->firstWhere("code", Recognition::CATEGORY_CODE);
        ...
        $recognitions = Recognition::query()
