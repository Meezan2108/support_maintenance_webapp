...
class CreateAnalyticalServiceLabSubmitNotification
{
    /**
     * Execute the action
     *
     ...
     * @return any
     */
    public function execute(AnalyticalServiceLab $analytical)
    {
        $options = [
            "link" => route("panel.analytical-service-lab.show", ["analytical" => $analytical->id])
        ];
        ...
        $options = [
            "link" => route("panel.analytical-service-lab.approvement", ["analytical" => $analytical->id]),
        ];
