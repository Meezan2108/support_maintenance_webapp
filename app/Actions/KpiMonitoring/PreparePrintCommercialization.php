...
class PreparePrintCommercialization
{
    /**
     * Execute the action
     *
    ...
    public function execute(
        ...
        $targetCategory = $targetCategories->firstWhere("code", Commercialization::CATEGORY_CODE);
        ...
        $targetPeriod = $targetPeriod->map(function ($period) use ($year, $researcher, $targetCategory, $targets) {
            ...
            $achievement = Commercialization::query()
        ...
        $commercializations = Commercialization::query()
