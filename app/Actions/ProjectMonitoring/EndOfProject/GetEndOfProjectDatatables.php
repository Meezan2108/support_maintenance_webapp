...
class GetEndOfProjectDatatables
{
    protected $columns = [];
    ...
    public function __construct()
    {
        ...
        $this->columns = [
            ...
            [
                "label" => "Duration",
                "name" => $proposal->qualifyColumn("schedule_duration"),
                "orderable" => true,
                "searchable" => true,
                "class" => "text-nowrap"
            ],
            ...
            [
                ...
                "class" => "text-nowrap",
                "searchtype" => "select",
                "options" => collect(ReportEndProject::ARR_STATUS)->map(function ($item, $index) {
                    return [
                        "id" => $index,
                        "label" => $item
                    ];
    ...
    public function execute(array $filters)
    {
        ...
        $data = ReportEndProject::with("proposal", "approvementStep")
            ->leftJoin(
                $proposal->getTable(),
            ...
            ->select(
                ...
                $proposal->qualifyColumn("schedule_duration"),
