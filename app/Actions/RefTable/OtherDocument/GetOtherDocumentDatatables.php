...
namespace App\Actions\RefTable\OtherDocument;

use App\Helpers\DatatablesHelper;
use App\Models\RefOtherDocument;

class GetOtherDocumentDatatables
{
    ...
    {
        $user = RefOtherDocument::when($filters['search_fields'] ?? false, function ($query) use ($filters) {
