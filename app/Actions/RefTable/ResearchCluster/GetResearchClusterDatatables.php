...
namespace App\Actions\RefTable\ResearchCluster;

use App\Helpers\DatatablesHelper;
use App\Models\RefResearchCluster;

class GetResearchClusterDatatables
{
    ...
    {
        $user = RefResearchCluster::when($filters['search_fields'] ?? false, function ($query) use ($filters) {
