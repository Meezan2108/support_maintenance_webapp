...
class TrfTableResource extends JsonResource
{
    /**
    ...
    private function getArrButton()
    {
        $show = [
            "icon" => "fas fa-info",
            "url" => route("panel.trf.show", ["proposal" => $this->id]),
        ...
        $edit = [
            "icon" => "fas fa-edit",
            "url" => route("panel.trf.edit", ["proposal" => $this->id]),
            "label" => "Edit Proposal",
        ...
        $comment = [
            ...
            "url" => route("panel.trf.comment", ["proposal" => $this->id]),
        ...
        $delete = [
            "icon" => "fas fa-trash",
            "url" => route("panel.trf.delete", ["proposal" => $this->id]),
        ...
        $download = [
            ...
            "url" => route("panel.trf.download", ["proposal" => $this->id]),
