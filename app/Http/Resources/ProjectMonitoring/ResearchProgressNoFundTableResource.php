...
class ResearchProgressNoFundTableResource extends JsonResource
{
    /**
    ...
    {
        return [
            "report_research_progress.id" => $this->id,
            "report_research_progress.project_title" => $this->project_title,
            "ref_report_type.description" => $this->description,
            "report_research_progress.approval_status" => $this->formatStatus($this->approval_status),
            "report_research_progress.updated_at" => $this->updated_at,
    ...
    private function formatStatus($status)
    {
        ...
        $statusStr = ReportResearchProgress::ARR_STATUS[$status] ?? " - ";
    ...
    private function getArrButton()
    {
        $show = [
            "icon" => "fas fa-info",
            "url" => route("panel.research-progress-no-fund.show", ["report" => $this->id]),
        ...
        $edit = [
            "icon" => "fas fa-edit",
            "url" => route("panel.research-progress-no-fund.edit", ["report" => $this->id]),
            "label" => "Edit Report",
        ...
        $comment = [
            ...
            "url" => route("panel.research-progress-no-fund.comment", ["report" => $this->id]),
        ...
        $delete = [
            "icon" => "fas fa-trash",
            "url" => route("panel.research-progress-no-fund.delete", ["report" => $this->id]),
            "label" => "Delete Report",
        ...
        $download = [
            ...
            "url" => route("panel.research-progress-no-fund.download", ["report" => $this->id]),
        ...
        $policy = new ResearchProgressNoFundPolicy();
