...
class EndOfProjectTableResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            "report_end_project.approval_status" => $this->formatStatus($this->approval_status),
            "report_end_project.updated_at" => $this->updated_at,
            "proposal.schedule_duration" => $this->schedule_duration . " Months",
    ...
    private function formatStatus($status)
    {
        ...
        $statusStr = ReportEndProject::ARR_STATUS[$status] ?? " - ";
    ...
    private function getArrButton()
    {
        $show = [
            "icon" => "fas fa-info",
            "url" => route("panel.end-of-project.show", ["report" => $this->id]),
        ...
        $edit = [
            "icon" => "fas fa-edit",
            "url" => route("panel.end-of-project.edit", ["report" => $this->id]),
            "label" => "Edit Report",
        ...
        $comment = [
            ...
            "url" => route("panel.end-of-project.comment", ["report" => $this->id]),
        ...
        $delete = [
            "icon" => "fas fa-trash",
            "url" => route("panel.end-of-project.delete", ["report" => $this->id]),
            "label" => "Delete Report",
        ...
        $download = [
            ...
            "url" => route("panel.end-of-project.download", ["report" => $this->id]),
