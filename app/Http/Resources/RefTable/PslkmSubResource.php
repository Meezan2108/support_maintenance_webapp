...
class PslkmSubResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            "id" => $this->id,
            "code" => $this->code,
            "ref_pslkm.description" => $this->pslkm,
    ...
    private function getArrButton()
    {
        $show = [
            "icon" => "fas fa-info",
            "url" => route("panel.ref-table.pslkm-sub.show", ["sub" => $this->id]),
        ...
        $edit = [
            "icon" => "fas fa-edit",
            "url" => route("panel.ref-table.pslkm-sub.edit", ["sub" => $this->id]),
            "label" => "Edit PSLKM",
        ...
        $delete = [
            "icon" => "fas fa-trash",
            "url" => route("panel.ref-table.pslkm-sub.delete", ["sub" => $this->id]),
            "label" => "Delete PSLKM",
