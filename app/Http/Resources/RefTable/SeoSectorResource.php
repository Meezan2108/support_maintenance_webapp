...
class SeoSectorResource extends JsonResource
{
    ...
    private function getArrButton()
    {
        $show = [
            "icon" => "fas fa-info",
            "url" => route("panel.ref-table.seo-sector.show", ["sector" => $this->id]),
            "label" => "Show Detail SEO Sector",
            "classStyle" => "btn-outline-info"
        ];

        $edit = [
            "icon" => "fas fa-edit",
            "url" => route("panel.ref-table.seo-sector.edit", ["sector" => $this->id]),
            "label" => "Edit SEO Sector",
            "classStyle" => "btn-outline-warning"
        ];

        $delete = [
            "icon" => "fas fa-trash",
            "url" => route("panel.ref-table.seo-sector.delete", ["sector" => $this->id]),
            "label" => "Delete SEO Sector",
