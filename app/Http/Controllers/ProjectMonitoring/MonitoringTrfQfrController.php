...
class MonitoringTrfQfrController extends Controller
{
    protected $policy;
    ...
    public function create(Request $request)
    {
        ...
        return Inertia::render('ProjectMonitoring/TrfMonitoring/Qfr/Create', [
    ...
    public function show(Request $request, ReportQuarterly $qfr)
    {
        ...
        return Inertia::render('ProjectMonitoring/TrfMonitoring/Qfr/Show', [
            "title" => "TRF Quarterly Monitoring | Research Project Monitoring",
            "additional" => [
                "filters" => $filters,
                "initActiveTab" => $request->active_tab,
    ...
    public function edit(Request $request, ReportQuarterly $qfr)
    {
        ...
        return Inertia::render('ProjectMonitoring/TrfMonitoring/Qfr/Edit', [
