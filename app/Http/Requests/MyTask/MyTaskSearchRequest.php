...
namespace App\Http\Requests\MyTask;
...
class MyTaskSearchRequest extends FormRequest
{
    /**
    ...
    {
        $orderField = DatatablesHelper::getOrderAbleField((new GetMyTaskDatatables)->getColumns());
