...
class AnalyticalServiceLabSearchRequest extends FormRequest
{
    /**
    ...
    {
        $orderField = DatatablesHelper::getOrderAbleField((new GetAnalyticalServiceLabDatatables)->getColumns());
