...
import VButtonDropdownCreate from "@/Shared/Buttons/VButtonDropdownCreate";
...
const { urlIndex, canCreate, columns, listLinkCreate } = props.additional;
...
const breadcrumbs = [
    {
        url: "#",
        label: "Report Progress External Fund (EF)",
    },
];
        ...
        <div class="card">
            <div class="card-body">
                <div v-if="canCreate" class="text-end mb-3">
                    <VButtonDropdownCreate :listLink="listLinkCreate">
                        Create Report
