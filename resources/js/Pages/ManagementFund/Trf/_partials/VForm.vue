...
const activeComponent = computed({
    get() {
        switch (activeTab.value) {
            case "objectives":
                baseUrl = appBaseUrl + "/trf/sub-form/form2";
                return {
            ...
            //     baseUrl = appBaseUrl + "/trf/sub-form/form3";
            //     return {
            ...
            case "research_approach":
                baseUrl = appBaseUrl + "/trf/sub-form/form4";
                return {
            ...
            //     };
            // case "benefits":
            //     baseUrl = appBaseUrl + "/trf/sub-form/form6";
            //     return {
            ...
            //     baseUrl = appBaseUrl + "/trf/sub-form/form7";
            //     return {
            ...
            //     baseUrl = appBaseUrl + "/trf/sub-form/form8";
            //     return {
            ...
            //     };
            // case "project_cost":
            //     baseUrl = appBaseUrl + "/trf/sub-form/form9";
            //     return {
            ...
            //     };
            default:
                baseUrl = appBaseUrl + "/trf/sub-form/form1";
                return {
