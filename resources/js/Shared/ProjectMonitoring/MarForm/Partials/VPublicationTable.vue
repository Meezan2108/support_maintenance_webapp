...
import VModalPublication from "../Modals/VModalPublication.vue";
...
const save = (value) => {
    if (editedIndex.value === false) {
        data.value.push({
            ...
            ref_pub_type_id: value.ref_pub_type_id,
            ref_pub_type_description: value.ref_pub_type_description,
            date: value.date,
        });
    } else {
        let index = editedIndex.value;
        data.value[index].title = value.title;
        data.value[index].publisher = value.publisher;
        data.value[index].ref_pub_type_id = value.ref_pub_type_id;
        data.value[index].ref_pub_type_description =
            value.ref_pub_type_description;
