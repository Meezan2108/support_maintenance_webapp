...
import VProjectExpenditureTableShow from "./Partials/VProjectExpenditureTableShow.vue";
    ...
    <div class="row">
        <div class="col-md-6 mb-3 order-md-0">
            <VInputReadonlyWithLabel
                ...
                :value="form.year + ' - Quarter ' + form.quarter"
                :isPlainText="false"
            />
        </div>
    </div>

    <VProjectExpenditureTableShow
