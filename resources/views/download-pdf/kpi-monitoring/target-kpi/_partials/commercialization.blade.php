<div id="publications-achhievement" class="line-height-1">
    ...
    <section>
        <div class="mb-1">
            <h2 class="title-1">KPI Achievement for R&D Commercialization in {{ $year }}.</h2>
        </div>
    </section>
    <section class="mb-2">
        <table class="table-border">
            ...
            <tr>
                <td>Commercialization (Products / Technologies)</td>
    ...
    <section>
        <table class="table-border" width="100%">
            <tr>
                <th width="10pt">No</th>
                <th  width="200pt">Product / Technology</th>
                <th>Taker</th>
                <th>Project Leader</th>
            </tr>
            @foreach($commercializations as $index => $item)
            <tr>
                <td>{{ ($index + 1) }}</td>
                <td>{{ $item->name }}</td>
                <td>{{ $item->taker }}</td>
