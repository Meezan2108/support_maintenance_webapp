...
use App\Actions\DataMigration\StoreProposalOtherDoc2;
use App\Actions\DataMigration\TransformProposalOtherDoc2;
use App\Helpers\EtlHelper;
use Illuminate\Database\Seeder;

class ProposalOtherDoc2OldDataSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $file = fopen(storage_path("csv/crims-db-v1/proposalotherdoc2.csv"), 'r');
        ...
        while (($row = fgetcsv($file)) !== FALSE) {
            ...
            $proposalDoc =  (new TransformProposalOtherDoc2)->execute($arrInsert);
            ...
            if ($arrInsert["ext"] && $arrInsert["doc"]) {
                ...
                (new StoreProposalOtherDoc2)->execute($proposalDoc, [
                    "file_name" => "ProposalOtherDoc2" . $ext,
