...
class ProposalProjectTeamOldDataSeeder extends Seeder
{
    protected $headers;
    ...
    public function run()
    {
        ...
        $file = fopen(storage_path("csv/crims-db-v1/ProjectTeam.csv"), 'r');
        ...
        while (($row = fgetcsv($file)) !== FALSE) {
            ...
            (new TransformProposalProjectTeam)->execute($arrInsert);
        }
