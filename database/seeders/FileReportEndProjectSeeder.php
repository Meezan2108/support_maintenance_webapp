...
class FileReportEndProjectSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        $targetTable = "report_end_project";
        $targetModel = "App\Models\ReportEndProject";

        $sourceTable = "Report";
        $sourceIdField = "idreport";

        $sourceFileField = "ReportFile";

        $arrFileType = ["pdf", "docx"];

        foreach ($arrFileType as $typeExt) {
            $filename = "ReportFile..{$typeExt}";
            $sql = "
